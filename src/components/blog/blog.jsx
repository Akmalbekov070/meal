...
export default function Blog() {
	return (
		<Box w={'full'} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'} pt={'20'}>
			<Box w={'50%'} border={'1px'} borderColor={'white'} p={10} boxShadow={'dark-lg'} borderRadius={'10'}>
				<Text>
				...
				<Box w={'full'} display={'flex'} px={10} pt={2}>
