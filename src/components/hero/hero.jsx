"use client"
import { Box, Button, Divider, Heading, Image, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Table, TableCaption, TableContainer, Tbody, Td, Text, Tfoot, Th, Thead, Tr, useDisclosure } from '@chakra-ui/react'
      ...
      {meal.map(el => (
        <Box key={el.idMeal} w={'full'} h={'600px'} position={'relative'}>
          ...
          <Box position={'absolute'} top={'150px'} left={20}>
            ...
            <Text w={'50%'} py={5}>{el.strInstructions.slice(0, 230)}...</Text>
            <Button onClick={onOpen} mt={4} variant={'solid'}>Watch Details</Button>
          </Box>
          <Modal size={'5xl'} isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
              ...
              <ModalBody>
                ...
                <Box>
                  <iframe width="100%" height="380" src={`https://www.youtube.com/embed/${el.strYoutube.slice(-11)}`} title="Jah Khalib – Искал-Нашёл | Премьера клипа" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </Box>
              </ModalBody>
              <ModalFooter>
